namespace Shapes2D {
    ...
    public class MenuItems {
        ...
        [MenuItem("GameObject/Shapes2D/Sprites/Arrow", false, 10)]
        private static void CreateArrow() {
            MenuItems.AddToSelectedNonCanvas(MenuItems.CreatePrefab("Arrow"));
        }
        ...
        [MenuItem("GameObject/Shapes2D/Sprites/Star", false, 10)]
        private static void CreateStar() {
            MenuItems.AddToSelectedNonCanvas(MenuItems.CreatePrefab("Star"));
        }
